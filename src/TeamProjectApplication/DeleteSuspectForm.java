...
public class DeleteSuspectForm extends JPanel implements ActionListener{
	...
	//main class for DeleteSuspectForm that builds the Panel
	public DeleteSuspectForm()
	{
		...
		//functionality for the clear button that clears all the fields and sets them to default
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(confirmation == 0)
		{
			//deletes the record from database using the entered suspectID
			suspectIn.deleteFromDatabase(SuspectID.getText());
			//clearfields method called to set the value to the default
			clearfields();
		}
	}
